...
class NetworkDelayDetector(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("in delay class")
    ...
    def _detector(self):
        while True :
            ...
            self.logger.info("In delay detector")
    ...
    def _send_echo_request(self):
        for datapath in list(self.datapaths.values()):
            ...
            data = "%.6f" % time.time()
            echo_req = parser.OFPEchoRequest(datapath, data=str.encode(data))
    ...
    def show_delay_statis(self):
        #if setting.TOSHOW and self.awareness is not None:		//Cheenu change
        if  self.awareness is not None:
            ...
            for src in self.awareness.graph:
                for dst in self.awareness.graph[src]:
                    ...
                    #self.create_edge_list(src, dst, delay)
